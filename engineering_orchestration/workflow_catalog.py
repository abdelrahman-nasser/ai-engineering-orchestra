...
def find_default_workflow_schema_path() -> Traversable | None:
    """Locate the tool-owned Workflow schema independently of the active project."""
    return schema_resource("workflow.schema.json")
...
def load_workflow_catalog(
    ...
    resolved_schema: Traversable | None = None
