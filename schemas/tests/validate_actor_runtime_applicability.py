...
SCHEMA_PATH = REPO_ROOT / "schemas" / "actor-runtime-applicability.schema.json"
FIXTURE_DIR = REPO_ROOT / "schemas" / "tests" / "actor-runtime-applicability"
...
FIXTURE_CASES: dict[str, ExpectedFailure | None] = {
    ...
    "invalid-actor-id-type.yaml": ExpectedFailure("type", ("actor_id",)),
...
def main() -> int:
    print("AI Engineering Orchestra - Actor-to-Runtime Applicability Schema Validation")
    print("=" * 80)
