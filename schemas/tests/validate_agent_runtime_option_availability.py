...
SCHEMA_PATH = (
    REPO_ROOT / "schemas" / "agent-runtime-option-availability.schema.json"
)
FIXTURE_DIR = (
    REPO_ROOT / "schemas" / "tests" / "agent-runtime-option-availability"
)
...
FIXTURE_CASES: dict[str, ExpectedFailure | None] = {
    ...
    "invalid-inference-option-field.yaml": ExpectedFailure(
...
def main() -> int:
    print(
        "AI Engineering Orchestra - Agent Runtime Option Availability "
        "Schema Validation"
    )
    print("=" * 91)
