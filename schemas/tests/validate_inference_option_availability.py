...
SCHEMA_PATH = REPO_ROOT / "schemas" / "inference-option-availability.schema.json"
FIXTURE_DIR = (
    REPO_ROOT / "schemas" / "tests" / "inference-option-availability"
)
...
def main() -> int:
    print(
        "AI Engineering Orchestra - Inference Option Availability Schema Validation"
    )
    print("=" * 88)
