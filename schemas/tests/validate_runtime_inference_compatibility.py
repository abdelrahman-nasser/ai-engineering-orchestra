...
SCHEMA_PATH = REPO_ROOT / "schemas" / "runtime-inference-compatibility.schema.json"
FIXTURE_DIR = REPO_ROOT / "schemas" / "tests" / "runtime-inference-compatibility"
...
FIXTURE_CASES: dict[str, ExpectedFailure | None] = {
    ...
    "valid-opaque-identifiers.yaml": None,
    ...
    "invalid-runtime-option-id-type.yaml": ExpectedFailure(
        "type", ("runtime_option_id",)
    ),
    "invalid-missing-option-id.yaml": ExpectedFailure("required", (), "option_id"),
    "invalid-empty-option-id.yaml": ExpectedFailure("minLength", ("option_id",)),
    "invalid-option-id-type.yaml": ExpectedFailure("type", ("option_id",)),
    "invalid-extra-field.yaml": ExpectedFailure("additionalProperties", ()),
    "invalid-compatible-field.yaml": ExpectedFailure("additionalProperties", ()),
    "invalid-state-field.yaml": ExpectedFailure("additionalProperties", ()),
...
def main() -> int:
    print("AI Engineering Orchestra - Runtime-to-Inference Compatibility Schema Validation")
    print("=" * 86)
